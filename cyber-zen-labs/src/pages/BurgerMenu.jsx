...
import { DivContainerAboutSC, DivWrapMenuSC, GridContentSC } from '../styled-components-css/styled-About'
import { DivContainerSC, DivWrapSC } from '../styled-components-css/styled-DEFAULT'
  ...
  return (
    ...
    <DivContainerAboutSC>
      <GridContentSC>
        ...
        <SpanTextElementMenuSC to ="#">CONTACTS</SpanTextElementMenuSC>
